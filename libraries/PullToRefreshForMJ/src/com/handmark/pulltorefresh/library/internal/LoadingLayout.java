...
public abstract class LoadingLayout extends FrameLayout implements
	...
	protected final ImageView mProgress_image;
	public static boolean flag = true;//false是默认的样式，true是加载新增的样式
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		default:
			if(!flag) {
				...
				LayoutInflater.from(context).inflate(
						R.layout.pull_to_refresh_header_vertical2, this);
			}
			break;
		}
		...
		mProgress_image = (ImageView) mInnerLayout
		...
		default:
			...
			mCompleteLabel = context.getString(R.string.pull_to_refresh_complete_label);
			break;
		}
	...
	public final void hideAllViews() {
		...
		if(!flag) {
			...
			if (View.VISIBLE == mProgress_image.getVisibility()) {
				mProgress_image.setVisibility(View.INVISIBLE);
			}
		}
	...
	public final void showInvisibleViews() {
		...
		if(!flag) {
			...
			if (View.INVISIBLE == mProgress_image.getVisibility()) {
