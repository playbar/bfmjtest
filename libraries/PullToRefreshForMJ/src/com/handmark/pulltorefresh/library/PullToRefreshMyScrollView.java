...
public class PullToRefreshMyScrollView extends PullToRefreshBase<ObservableScrollView> {
	...
	final class InternalScrollViewSDK9 extends ScrollView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy(PullToRefreshMyScrollView.this, deltaX,
