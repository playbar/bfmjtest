...
public class GLVideoRect extends GLRect {
	...
	public void draw(GLPlayerView view){
		if (view == null && view.getRenders().size()  == 0){
			return;
		}
...
//		GLES30.glEnable(GLES30.GL_DEPTH_TEST);
	...
	public void release(){
		GLES30.glDeleteBuffers(6, new int[]{vboVertexNew, vboTextureNew, vboTextureLeftNew, vboTextureRightNew, vboTextureTopNew, vboTextureBottomNew}, 0);
	}
}
