...
public class PackageUtils{
    ...
    public static final int install(Context context, String filePath) {
        System.out.println("testtest PackageUtils install PackageUtils.isSystemApplication(context):"+PackageUtils.isSystemApplication(context));
...
//        return installNormal(context, filePath) ? INSTALL_SUCCEEDED : INSTALL_FAILED_INVALID_URI;
    ...
    public static boolean isSystemApplication(Context context) {
        System.out.println("testtest PackageUtils isSystemApplication context:"+context);
        if (context == null) {
            return false;
        }
    ...
    public static boolean isSystemApplication(PackageManager packageManager, String packageName) {
        System.out.println("testtest PackageUtils isSystemApplication packageName:"+packageName);
        ...
        try {
            ...
            System.out.println("testtest PackageUtils isSystemApplication app.flags:"+app.flags);
            System.out.println("testtest PackageUtils isSystemApplication ApplicationInfo.FLAG_SYSTEM:"+ApplicationInfo.FLAG_SYSTEM);
            System.out.println("testtest PackageUtils isSystemApplication ApplicationInfo.FLAG_SYSTEM:"+ApplicationInfo.FLAG_UPDATED_SYSTEM_APP);
            boolean isSystem = (app.flags & ApplicationInfo.FLAG_SYSTEM) > 0;
            boolean isSystemUpdate = (app.flags & ApplicationInfo.FLAG_UPDATED_SYSTEM_APP) > 0;
            return (app != null && (isSystem || isSystemUpdate));
        } catch (NameNotFoundException e) {
            System.out.println("testtest PackageUtils NameNotFoundException e:"+e.toString());
            e.printStackTrace();
        }
        return false;
    }
