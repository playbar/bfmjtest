...
public class BatteryStateReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (null != intent) {
            BaseApplication.INSTANCE.setBatteryLevel(intent.getIntExtra(UnityPublicBusiness.BATTERY_LEVEL, 0));//电池电量
            BaseApplication.INSTANCE.setBatteryScale(intent.getIntExtra(UnityPublicBusiness.BATTERY_SCALE, 100));//电池最大电量
            BaseApplication.INSTANCE.setBatteryTemperature(intent.getIntExtra(UnityPublicBusiness.BATTERY_TEMPERATURE, 0));//电池温度
            BaseApplication.INSTANCE.setBatteryStatus(intent.getIntExtra(UnityPublicBusiness.BATTERY_STATUS, BatteryManager.BATTERY_STATUS_UNKNOWN));
            ...
            switch (status) {
                ...
                case android.os.BatteryManager.BATTERY_STATUS_DISCHARGING://放电
                    ...
                    LogHelper.e("infos","batteryLevel==="+batteryLevel);
            ...
            batteryLevel = intent.getIntExtra(UnityPublicBusiness.BATTERY_LEVEL, 0);
            batterySum = intent.getIntExtra(UnityPublicBusiness.BATTERY_SCALE, 100);
            LogHelper.e("infos","Battery.status==="+status+"==batteryLevel=="+batteryLevel);
            /**
             * 测试代码
             */
