package com.baofeng.mj.business.historybusiness;
...
public class HistoryBusiness {
     ...
     * 获取在线历史文件夹
     */
    public static String getCinemaHistoryFolder() {
        if(TextUtils.isEmpty(cinemaHistoryFolder)){
            cinemaHistoryFolder = FileStorageUtil.getMojingDir() + "history/cinemaHistory/" + UserSpBusiness.getInstance().getUid();
        }
        FileStorageUtil.mkdir(cinemaHistoryFolder);
        return cinemaHistoryFolder;
    }
     ...
     * @param videoId 视频id
     */
    public static String getCinemaHistoryPath(String videoId) {
        return getCinemaHistoryFolder() + "/" + videoId + ".history";
    }
    ...
    public static VideoViewparam JudgeVideoType(String dimension, String is_Pano)
    {
        ...
        {
            videoViewparam.mVideo3DType = Video3DType.Video2D.ordinal()+1;
            videoViewparam._videoModelType = VideoModelType.Mode_Sphere360.ordinal()+1;
        }
        else if (dimension.equals("1"))//2d
        {
            ...
            else if (is_Pano.equals("4"))//2d 立方体
            {
                ...
                videoViewparam.mVideo3DType = Video3DType.Video2D.ordinal()+1;
                videoViewparam._videoModelType = VideoModelType.Mode_Box.ordinal()+1;
            }
        }
        else if (dimension.equals("2") && is_Pano.equals("2"))//3d 上下
        {

            videoViewparam.mVideo3DType = Video3DType.VideoUD3D.ordinal()+1;
            videoViewparam._videoModelType = VideoModelType.Mode_Sphere360.ordinal()+1;
        ...
        else if (dimension.equals("3") && is_Pano.equals("3"))//3d 180 左右
        {
            ...
            videoViewparam.mVideo3DType = Video3DType.VideoLR3D.ordinal()+1;
            videoViewparam._videoModelType = VideoModelType.Mode_Sphere180.ordinal()+1;
        }
        else
        {
            videoViewparam.mVideo3DType = Video3DType.Video2D.ordinal()+1;
