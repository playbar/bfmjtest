 ...
 * 用户信息
 */
public class UnityUserInfoApi extends UnityBaseApi {
...
//    private Handler mHandler=new Handler();
    ...
    public void queryUserInfoById(final Context context, String userId, ApiCallBack<Response<List<SimpleUserInfo>>> apiCallBack) {
        ...
        getAsyncHttpClient().get(context, url, params, new ApiResponseHandler<Response<List<SimpleUserInfo>>>(apiCallBack) {
            @Override
...
//        });
    ...
    public void updateModouCount(Context context, ApiCallBack<String> apiCallBack) {
        ...
        getAsyncHttpClient().get(context, url, params, new ApiResponseHandler<String>(apiCallBack) {
            @Override
    ...
    public void login(Context context, String phoneNum, String password, ApiCallBack<String> apiCallBack) {
        ...
        getAsyncHttpClient().get(context, ConfigUrl.MJ_LOGIN_URL, paramMap, new ApiResponseHandler<String>(apiCallBack) {
            @Override
            public String parseResponse(String responseString) {
                return responseString;
            }
    ...
    public void loadingPayed(Context context, ApiCallBack<String> apiCallBack) {
        ...
        getAsyncHttpClient().get(context, url, null, new ApiResponseHandler<String>(apiCallBack) {
            @Override
            public String parseResponse(String responseString) {
                return responseString;
            }
    ...
    public void getVerifyCode(Context context, String regist_tel, String send_type, ApiCallBack<String> apiCallBack) {
        ...
        getAsyncHttpClient().get(context, ConfigUrl.MJ_VERIFYCODE_URL, paramMap, new ApiResponseHandler<String>(apiCallBack) {
            @Override
            public String parseResponse(String responseString) {
                return responseString;
            }
    ...
    public void regist(Context context, String regist_tel, String password, String verifyCode, ApiCallBack<String> apiCallBack) {
        ...
        getAsyncHttpClient().get(context, ConfigUrl.MJ_REGISTER_URL, paramMap, new ApiResponseHandler<String>(apiCallBack) {
            @Override
            public String parseResponse(String responseString) {
                return responseString;
            }
    ...
    public void resetPwd(Context context, String user_tel, String user_new_pwd, String verifyCode, ApiCallBack<String> apiCallBack) {
        ...
        getAsyncHttpClient().get(context, ConfigUrl.MJ_RESETPWD_URL, paramMap, new ApiResponseHandler<String>(apiCallBack) {
            @Override
            public String parseResponse(String responseString) {
                return responseString;
            }
    ...
    public void bindPhone(Context context, String logintype, String openid, String user_tel, String user_check, ApiCallBack<String> apiCallBack) {
        ...
        getAsyncHttpClient().get(context, ConfigUrl.MJ_BINDPHONE_URL, paramMap, new ApiResponseHandler<String>(apiCallBack) {
            @Override
            public String parseResponse(String responseString) {
                return responseString;
            }
    ...
    public void queryUserIdByOpenId(Context context, String openType, String openId,ApiCallBack<String> apiCallBack) {
        ...
        getAsyncHttpClient().get(context,ConfigUrl.MJ_NO_BY_OPENID_URL, paramMap,  new ApiResponseHandler<String>(apiCallBack) {
    ...
    public void getTaskList(Context context, String userId, String from, String version, ApiCallBack<String> apiCallBack) {
        ...
        params.put("sign", sign);
        getAsyncHttpClient().get(context, ConfigUrl.MJ_TASKLIST_URL, params, new ApiResponseHandler<String>(apiCallBack) {
            @Override
            public String parseResponse(String responseString) {
                return responseString;
            }
    ...
    public void getTask(Context context, String userId, String from, String version, String aid, ApiCallBack<String> apiCallBack) {
        ...
        params.put("aid", aid);
        params.put("sign", sign);
        getAsyncHttpClient().get(context, ConfigUrl.MJ_TASKGET_URL, params,  new ApiResponseHandler<String>(apiCallBack) {
            @Override
            public String parseResponse(String responseString) {
                return responseString;
            }
    ...
    public void getStormUserInfo(Context context,String token,ApiCallBack<String> apiCallBack){
        ...
        getAsyncHttpClient().get(context, ConfigUrl.STORM_USER_INFO, paramMap,  new ApiResponseHandler<String>(apiCallBack) {
    ...
    public void changePhone(Context context,String userId,String userNewPhone,String check,ApiCallBack<String> apiCallBack){
        ...
        getAsyncHttpClient().get(context, url, paramMap,  new ApiResponseHandler<String>(apiCallBack) {
    ...
    public void getIfHasGift(ApiCallBack<String> apiCallBack) {
        ...
        getAsyncHttpClient().get(BaseApplication.INSTANCE, ConfigUrl.getIfHasNewGiftUrl(), params, new ApiResponseHandler<String>(apiCallBack) {
            @Override
            public String parseResponse(String responseString) {
                return responseString;
            }
