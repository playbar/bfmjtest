...
public class SoundBarView extends GLRelativeView{
    ...
    private void createBarView() {
        ...
        glRelativeView.setBackground(R.drawable.play_bg_control_normal_740_60);
        glRelativeView.setMargin((88f-22f)+88f+(40f-22f),30f,0f,0f);

        soundSeekBar = new SoundSeekBar(mContext);
        soundSeekBar.setBackground(R.drawable.play_volume_slider_bg);
        soundSeekBar.setBarImage(R.drawable.play_volume_cursor_normal);
            ...
            public void onFocusChange(GLRectView view, boolean focused) {
                if(focused) {
                    ...
                    if(soundFlag) {
                        ...
                        mSoundBtn.setImageBg(R.drawable.play_icon_mute_hover1);
                    }
                } else {
                    ...
                    if(soundFlag) {
                        ...
                        mSoundBtn.setImageBg(R.drawable.play_icon_mute_normal);
                    }
                }
            }
        });
