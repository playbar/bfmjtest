...
public class GLSeekBarView extends GLProcessView {
    ...
    private int display_image_width = 10,display_image_height=30;
    ...
    public GLSeekBarView(Context context){
        ...
        setBackground(R.drawable.play_control_slider_bg);
//        setPrestrainColor(R.drawable.play_control_slider_progress);
//        setPrestrainProcess(0);
        setBarImage(R.drawable.play_control_cursor_normal);
//        setProcess(100);
//        setProcessColor(R.drawable.play_control_slider_progress_1);
        setProcess(0);
    ...
    private void initView(){
        ...
        mDisplayView.setPadding(0,15,0,0);
//        mDisplayView.setBackground(new GLColor(0xff0000));
        ...
        display_image.setBackground(R.drawable.play_control_cursor_hover);
