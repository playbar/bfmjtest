...
public class ClearCacheDialog {
    ...
    public ClearCacheDialog(Activity context) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.dialog_clear_cache,null);//生成布局文件
        ...
        TextView tv_clear = (TextView) view.findViewById(R.id.tv_clear);//右面按钮
        //左面按钮点击事件
     ...
     * 显示对话框
     */
    public void showDialog(MyDialogInterface myDialogInterface, MyDialogInterfaceCancel myDialogInterfaceCancel){
        if(dialog != null && !dialog.isShowing()){
            this.myDialogInterface = myDialogInterface;
